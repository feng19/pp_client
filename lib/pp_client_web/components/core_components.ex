defmodule PpClientWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(PpClientWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(PpClientWeb.Gettext, "errors", msg, opts)
    # end
